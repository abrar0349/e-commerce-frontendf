...
function Cart() {
    ...
    const increaseQty = async(id,qty) =>{
        const response = await fetch(SummaryApi.updateQuntityOfCart.url,{
            method : SummaryApi.updateQuntityOfCart.method,
            credentials : 'include',
            headers : {
                "content-type" : 'application/json'
            },
    ...
    const deleteCartProduct = async(id)=>{
        const response = await fetch(SummaryApi.deleteToCart.url,{
            method : SummaryApi.deleteToCart.method,
            credentials : 'include',
            headers : {
                "content-type" : 'application/json'
            },
